...
ActiveRecord::Schema.define(version: 2020_05_16_010353) do
  ...
  create_table "recomendations", force: :cascade do |t|
    ...
    t.index ["service_id"], name: "index_recomendations_on_service_id"
  ...
  add_foreign_key "recomendations", "services"
